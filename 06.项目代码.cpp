 ...
 *
 * Assuming that tree is a well-formed non-empty encoding tree and
 ...
 *
 * Assuming that the queues are well-formed and represent
 ...
 *
 * Assuming the input data is well-formed and was created by a correct
...
EncodingTreeNode* buildHuffmanTree(string text) {
    ...
    if(flag){
        error("The message text does not contain at least two distinct characters");
    }
 ...
 *
 * Assuming tree is a valid non-empty encoding tree and contains an
 ...
 *
 * Assuming the input queues are empty on entry to this function.
 *
 * Assuming tree is a valid well-formed encoding tree.
 *
 */
